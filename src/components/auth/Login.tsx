...
const Login: React.FC<LoginProps> = () => {
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen flex items-center justify-center bg-gray-50">
      ...
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 xl:p-12 2xl:p-16">
          {/* Header */}
          ...
          {isLoading || !isGoogleLoaded ? (
            ...
            <div className="space-y-4 sm:space-y-6 lg:space-y-8">
              ...
              <button
                ...
                disabled={!isGoogleLoaded || isSigningIn}
                className="flex items-center justify-center gap-3 lg:gap-4 xl:gap-5 2xl:gap-6 bg-white border-2 border-gray-300 rounded-lg lg:rounded-xl px-4 py-3 sm:px-6 sm:py-4 lg:px-8 lg:py-5 xl:px-10
  ...
  shadow-sm hover:shadow-md"
          ...
          {/* Error Message */}
          {error && (
            <div className="mt-4 sm:mt-6 lg:mt-8 p-3 sm:p-4 lg:p-5 bg-red-50 border border-red-200 rounded-lg lg:rounded-xl">
              <div className="text-red-600 text-sm sm:text-base lg:text-lg xl:text-xl 2xl:text-2xl text-center">
                {error}
              </div>
              <button
        ...
        {/* Footer */}
        <div className="mt-6 sm:mt-8 lg:mt-10 xl:mt-12 text-center text-gray-400 text-xs sm:text-sm lg:text-base xl:text-lg 2xl:text-xl">
          &copy; {new Date().getFullYear()} IMPAG Admin
        </div>
      </div>
    </div>
  );
