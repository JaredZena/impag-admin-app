...
const ProductTable: React.FC<ProductTableProps> = ({ products, loading = false }) => {
      ...
      <table className="min-w-full border-collapse">
        ...
        <tbody>
          {products.length === 0 && !loading ? (
            <tr>
              <td colSpan={6} className="text-center py-8 sm:py-12 text-gray-500">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Intenta ajustar tus filtros de búsqueda</p>
                </div>
              </td>
            </tr>
          ) : (
